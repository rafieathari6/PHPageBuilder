...
class ThemeBlock
{
    ...
    public function getThumbPath()
    {
        ...
        return $blockThumbsFolder . $this->blockSlug . '/' . file_get_contents($this->getViewFile()) . '.jpg';
    }

    public function getThumbUrl()
    {
        return phpb_theme_asset('block-thumbs/' . $this->blockSlug . '/' . file_get_contents($this->getViewFile()) . '.jpg');
    }
